...
const getGuardIdByMinute = (input) => {
    ...
    const {guardId, ranges} = getGuardAsleepTheMost(getTimeAsleep(parseRecords(input)));
...
const input = `[1518-09-24 00:59] wakes up
...
//console.log(parseRecords(input));

const firstPartPuzzleSolution = getGuardIdByMinute(input);
